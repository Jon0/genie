...
public:
	...
	virtual bool canInvoke(Instance *, Instance *) = 0;	// parameter is the target of invokation
	virtual bool canInvoke(IsoCoord *) = 0;
	virtual void invoke(Instance *, Instance *) = 0;
	virtual void invoke(Instance *, IsoCoord *, float) = 0;
	virtual bool complete(Instance *, void *) = 0; // return true when task is complete
